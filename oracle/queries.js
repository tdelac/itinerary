...
/*        
  ...
  get_landmark_by_stars_weighted_utility: function(city_name, day, rows, t, b) {
  ...
  get_morning_landmark_by_stars_dist_weighted_utility: function(city_name, day, rows, lat, long, t, b) {
    return ("WITH weighted_stars AS ( "
  ...
  get_afternoon_landmark_by_stars_dist_weighted_utility: function(city_name, day, rows, lat, long, t, b) {
    return ("WITH weighted_stars AS ( "
            + "SELECT b.name, b.stars, b.address, bh.open, bh.close, b.latitude, b.longitude "
            + "FROM (business b "
              + "INNER JOIN landmark l "
  ...
  get_evening_landmark_by_stars_dist_weighted_utility: function(city_name, day, rows, lat, long, t, b) {
    return ("WITH weighted_stars AS ( "
            + "SELECT b.name, b.stars, b.address, bh.open, bh.close, b.latitude, b.longitude "
            + "FROM (business b "
              + "INNER JOIN landmark l "
  ...
  get_breakfast_by_stars_weighted_utility: function(city_name, day, rows, t, b) {
    return ("WITH weighted_stars AS ( "
            + "SELECT b.name, b.stars, b.address, bh.open, bh.close, b.latitude, b.longitude "
            + "FROM (business b "
  ...
  get_lunch_by_stars_weighted_utility: function(city_name, day, rows, t, b) {
    return ("WITH weighted_stars AS ( "
            + "SELECT b.name, b.stars, b.address, bh.open, bh.close, b.latitude, b.longitude "
            + "FROM (business b "
              + "INNER JOIN restaurant r "
  ...
  get_dinner_by_stars_weighted_utility: function(city_name, day, rows, t, b) {
    return ("WITH weighted_stars AS ( "
            + "SELECT b.name, b.stars, b.address, bh.open, bh.close, b.latitude, b.longitude "
            + "FROM (business b "
              + "INNER JOIN restaurant r "
